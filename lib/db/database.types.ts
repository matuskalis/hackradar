...
export type Database = {
  ...
  public: {
    Tables: {
      geocode_cache: {
        Row: {
          ...
          lat: number | null
          lng: number | null
          precision: Database["public"]["Enums"]["location_precision"] | null
          query: string
          raw: Json | null
        }
        Insert: {
    ...
    Functions: {
      ...
      hackathons_in_bbox: {
        Args: {
          ...
          formats?: Database["public"]["Enums"]["hackathon_format"][]
          free_only?: boolean
          from_at?: string
          max_lat: number
          max_lng: number
    ...
    Enums: {
      hackathon_format: "onsite" | "online" | "hybrid"
      hackathon_source:
        | "manual"
        | "submit"
        | "devpost"
        ...
        | "hackclub"
        | "ics"
      hackathon_status: "pending" | "published" | "rejected" | "cancelled"
      location_precision: "venue" | "city"
    }
    CompositeTypes: {
      geometry_dump: {
        path: number[] | null
